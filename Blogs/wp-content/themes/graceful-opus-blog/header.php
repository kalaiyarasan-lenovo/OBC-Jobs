...
<body <?php body_class(); ?>>
	...
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'graceful-opus-blog' ); ?></a>	
	...
	<div id="site-container">
		...
		<?php
			if ( is_home() && !is_paged() ) {
				...
				$graceful_popular_post_enabled = graceful_opus_blog_options('popular_post_ticker_show');
			    ...
			    $graceful_featured_boxes_enabled = graceful_opus_blog_options('featured_boxes_show');
