...
<div class="content-wrap">
	...
	<h1>
		...
		printf(
			...
			esc_html__( 'Search Results for: %s', 'graceful-opus-blog' ),
	...
	<?php endif; ?>
	<?php if ( is_category() ) { ?>
		<h1 class="graceful-opus-category-title">
	...
	<ul class="content-column">
					...
					<div class="post-content-col">
							...
							<div class="post-meta clear-fix">
								...
								<strong class="post-title-author">
									<?php if ( graceful_options( 'post_page_show_author' ) ) :
										esc_html_e( ' - By', 'graceful-opus-blog' );
										echo '&nbsp;';
							...
							<div class="post-page-content">
								...
								if ( graceful_options( 'post_page_post_description' ) === 'content' ) {
									...
									if ( graceful_options( 'basic_content_width' ) === 'full') {
										...
										$excerpt_length = graceful_opus_blog_options( 'blog_grid_excerpt_length' );
										echo esc_html( graceful_excerpt( $excerpt_length ) );
									}
								}
						...
						<?php if ( graceful_options( 'post_page_show_more' ) ) : ?>
							<div class="continue-read">
								<a href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Read More', 'graceful-opus-blog' ); ?></a>
							</div>
						<?php endif; ?>
						</footer>
		...
		<?php endwhile; else: ?>
			<div class="no-result-found">
				<h3><?php esc_html_e( 'Nothing Found!', 'graceful-opus-blog' ); ?></h3>
				<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'graceful-opus-blog' ); ?></p>
