...
/**
 * Title: Template Cart
 * Slug: creativ-construction-fse/template-cart
 * Categories: template
 * Inserter: false
 */
?>
...
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'You may be interested in…', 'creativ-construction-fse' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php esc_html_e( 'Your cart is currently empty!', 'creativ-construction-fse' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php esc_html_e( 'Browse store', 'creativ-construction-fse' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'New in store', 'creativ-construction-fse' ); ?></h2>
<!-- /wp:heading -->
