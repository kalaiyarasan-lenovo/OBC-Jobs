 ...
 * Slug: creativ-construction-fse/template-product-search-results
 * Categories: template
 * Inserter: false
 */
?>
...
<!-- wp:query-no-results -->
<!-- wp:paragraph -->
<p><?php esc_html_e( 'No products were found matching your selection.', 'creativ-construction-fse' ); ?></p>
<!-- /wp:paragraph -->
