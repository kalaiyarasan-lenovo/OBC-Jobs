 ...
 * Slug: creativ-construction-fse/template-blog-listing
 * Categories: template
 * Inserter: false
 */
?>
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"creativ-construction-fse","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->